...
const CLASSES = [
  {
    grade: "Primary (Grade 1-3)",
    time: "8:30 AM - 9:30 AM",
    focus: "Buddhist stories, basic precepts, chanting",
  },
  {
    grade: "Junior (Grade 4-6)",
    time: "8:30 AM - 10:00 AM",
    focus: "Life of the Buddha, Jataka tales, discipline",
  },
  {
    grade: "Senior (Grade 7-9)",
    time: "9:00 AM - 10:30 AM",
    focus: "Dhamma philosophy, meditation basics",
  },
  {
    grade: "Advanced (Grade 10+)",
    time: "9:00 AM - 11:00 AM",
    focus: "Exam preparation, Abhidhamma introduction",
  },
];
    ...
    <div>
      ...
      <section id="intro" className="section-pad scroll-mt-24">
        <div className="container-wide grid items-center gap-12 lg:grid-cols-2">
          <Reveal>
            <SectionHeading
              align="left"
              eyebrow={t("nav.introduction")}
              title={t("dahamPasala.introTitle")}
            />
            <p className="mt-6 max-w-lg text-base leading-relaxed text-ink-900/60 dark:text-cream-100/60">
              Every Sunday morning, children from across Kalatuwagama gather at
              Sri Gunarathana Daham Pasala to learn the teachings of the Buddha.
              Through storytelling, chanting, discussion and gentle guidance,
              our teachers nurture both knowledge and character — helping
              students carry these values into everyday life.
            </p>
      ...
      >
        <div className="container-wide">
          <SectionHeading
            ...
            title={t("dahamPasala.teachersTitle")}
          />
      ...
      <section className="section-pad">
        <div className="container-wide">
          <SectionHeading
            ...
            title={t("dahamPasala.classesTitle")}
          />
                ...
                <div
                  className={`flex flex-col gap-2 px-6 py-5 sm:flex-row sm:items-center sm:justify-between ${
                    i % 2 === 0
                      ...
                      : "bg-cream-100/60 dark:bg-white/[0.02]"
                  }`}
                >
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-ink-900/55 dark:text-cream-100/55">
                      {c.focus}
                    </p>
                  </div>
      ...
      {/* {(loading || events.length > 0) && (
        ...
        >
          <div className="container-wide">
            <SectionHeading
              eyebrow={t("nav.dp_events")}
              title={t("dahamPasala.eventsTitle")}
            />
      ...
      {/* <section id="gallery" className="section-pad scroll-mt-24">
        <div className="container-wide">
          <SectionHeading
            eyebrow={t("nav.dp_gallery")}
            title={t("dahamPasala.galleryTitle")}
          />
